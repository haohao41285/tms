...
@push('meta_seo')
    ...
    <meta property="og:url" content="{{ route('fe.home') }}" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="{{__('fe.menu.home')}}" />
    <meta property="og:description" content="{{ __('fe.seo.home.description') ." - ". ENV('APP_NAME') }}" />
@endpush
