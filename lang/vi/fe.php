...
return [
    ...
    'faqs' => [
        ...
        'websites' => [
            'title' => 'Websites',
            'qa1' => [
                'question' => 'Thời gian để xây dựng một website trong bao lâu?',
                'slug' => 'thoi-gian-de-xay-dung-mot-website-trong-bao-lau',
                'answer' => 'Thông thường từ 1, 2 tháng sau khi thống nhất kế hoạch. Tùy thuộc vào loại dự án và yêu cầu của quý khách về chức năng, giao diện cũng như công nghệ sử dụng có thể thời gian sẽ nhanh hơn hoặc thời gian nhiều hơn.'
            ],
            'qa2' => [
                'question' => 'Quy trình làm việc để xây dựng một website?',
                'slug' => 'quy-trinh-lam-viec-de-xay-dung-mot-website',
                'description' => 'Với một quy trình rõ ràng từng bước:',
                'answer' => '
                <ul>
                ...
                'note' => 'Dự án sẽ được bào hành suốt đời. Nâng cấp được tính phí theo chức năng và cấp độ khách hàng (có thể là miễn phí)'
            ],
            'qa3' => [
            ...
            'qa4' => [
                ...
                'slug' => 'loi-ich-cua-viec-xay-dung-website',
